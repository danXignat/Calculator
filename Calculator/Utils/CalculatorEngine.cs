...
namespace Calculator.Utils {
    ...
    internal class CalculatorEngine {
        ...
        static public Dictionary<string, OpData> SupportedOp = new Dictionary<string, OpData> {
            ...
            { "NOT", new OpData((lhs, _) => (double)(~(long)lhs), Arity.Unary, Operations.NOT) },
        ...
        static public string Calculate(string op, string lhs, string? rhs = null, string numerationBase = "10") {
            string convertedLhs = BaseConverter.ConvertBase(lhs, int.Parse(numerationBase), 10);
            string convertedRhs = rhs != null ? BaseConverter.ConvertBase(rhs, int.Parse(numerationBase), 10) : "0";
            ...
            return BaseConverter.ConvertBase(result, 10, int.Parse(numerationBase));
        }
